...
<html>
  <head>
    ...
    <div class="container">
        ...
        <div class="selecteur">
            <a href="../selectionmonum/choixstat5.php">
                <div class="droite">
                    <div id="mourrant" class="rectangle">
                        <h2 class="choix" id="aleg">Mourrant</h2>    
                    </div>
                    <div class="covopa2">
            ...
            <a href="../selectionmonum/selection2.1.php">
                <div class="gauche">
                    <div id="guerrier" class="rectangle2">
                    <h2 class="choix" id="guer">Guerrier</h2>
                    </div>

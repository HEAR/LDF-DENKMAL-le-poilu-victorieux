...
<html>
  <head>
    ...
    <div class="container">
        ...
        <div class="selecteur">
            <a href="../selectionmonum/selection1.2.php">
                <div class="droite">
                    <div id="allegorie" class="rectangle">
                        <h2 class="choix" id="aleg">All&eacute;gorie</h2>    
                    </div>
                    <div class="covopa2">
            ...
            <a href="../selectionmonum/selection1.1.php">
                <div class="gauche">
                    <div id="millitaire" class="rectangle2">
                    <h2 class="choix" id="mili">Millitaire</h2>
                    </div>

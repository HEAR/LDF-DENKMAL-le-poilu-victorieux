  ...
  <head>
    ...
    <!--END HEADER-->
        ...
        <div class="contentbox3"> 
            ...
            <div id="marges"><img id="socle_back_ornements2" src="../socles/imgs-socle/socle2big.png"></div>
            ...
            <div id="ornement_s1">
                ...
                <a id="ornement_chevron" class="prev-ornement prev5-ornement" href="#ornement_s4"></a>
                    ...
                    <ul id="S_ornement_content">
                        <li class="ornement1"><img src="../ornements/img/ornement1.png"></li>            
                        <li class="ornement2"><img src="../ornements/img/ornement2.png"></li>            
                        <li class="ornement3"><img src="../ornements/img/ornement3.png"></li>            
                        <li class="ornement4">
                            <img id="ornement4" src="../ornements/img/ornement4.png" style="width:240px;" ></li>            
                        <li class="ornement5"><img src="../ornements/img/ornement5.png"></li>            
                    </ul>  
                                <?php include '../textes/contenu-ornement.php';?>
                                
                                <div id="boutonsdevalidations">
                        <a class="boutonsavecclasse1" href="../cartes/choix_emplacement_poilu_victorieux_socle3_ornement1.php">
                            <div id="bouton-ornement">Choisir cet ornement</div></a>
                        <a class="boutonsavecclasse2"  href="../cartes/choix_emplacement_poilu_victorieux_socle3_ornement2.php">
                            <div id="bouton-ornement">Choisir cet ornement</div></a>    
                        <a class="boutonsavecclasse3" href="../cartes/choix_emplacement_poilu_victorieux_socle3_ornement3.php">
                            <div id="bouton-ornement">Choisir cet ornement</div></a>
                        <a class="boutonsavecclasse4"  href="../cartes/choix_emplacement_poilu_victorieux_socle3_ornement4.php">
                            <div id="bouton-ornement">Choisir cet ornement</div></a>    
                        <a class="boutonsavecclasse5"  href="../cartes/choix_emplacement_poilu_victorieux_socle3_ornement5.php">
                            <div id="bouton-ornement">Choisir cet ornement</div></a>    
                                </div>
            ...
            <img id="statmin-drapeau" src="../statues/statue9min.png"/>
            <img style="display:none;" accesskey=""id="soclemin" src="../socles/imgs-socle/socle9.png">
            <img style="display:none;" id="soclemin" src="../socles/imgs-socle/socle10.png">
            <img id="soclemin" src="../socles/imgs-socle/socle11.png">
                </div>

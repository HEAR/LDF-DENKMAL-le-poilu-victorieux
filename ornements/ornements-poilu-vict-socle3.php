  ...
  <head>
    ...
    <!--END HEADER-->
        ...
        <div class="contentbox3"> 
            ...
            <div id="ornement_s1">
                ...
                <a id="ornement_chevron" class="prev-ornement prev5-ornement" href="#ornement_s4"></a>
                    ...
                    <ul id="S_ornement_content">
                        ...
                        <a class="boutonsavecclasse1" href="../cartes/choix_emplacement_poilu_vict_socle3_ornement1.php">
                            <div id="bouton-ornement">Choisir cet ornement</div></a>
                        <a class="boutonsavecclasse2"  href="../cartes/choix_emplacement_poilu_vict_socle3_ornement2.php">
                            <div id="bouton-ornement">Choisir cet ornement</div></a>    
                        <a class="boutonsavecclasse3" href="../cartes/choix_emplacement_poilu_vict_socle3_ornement3.php">
                            <div id="bouton-ornement">Choisir cet ornement</div></a>
                        <a class="boutonsavecclasse4"  href="../cartes/choix_emplacement_poilu_vict_socle3_ornement4.php">
                            <div id="bouton-ornement">Choisir cet ornement</div></a>    
                        <a class="boutonsavecclasse5"  href="../cartes/choix_emplacement_poilu_vict_socle3_ornement5.php">
                            <div id="bouton-ornement">Choisir cet ornement</div></a>    
                                </div>
            ...
            <img id="statmin-victoire" src="../statues/statue10min.png"/>

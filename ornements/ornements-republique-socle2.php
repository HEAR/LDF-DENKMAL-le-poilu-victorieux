            ...
            <div id="ornement_s1">
                <div id="ornement_s2">
                    <div id="ornement_s3">
                        ...
                        <a class="boutonsavecclasse1" href="../cartes/choix_emplacement_republique_socle2_ornement1.php">
                            <div id="bouton-ornement">Choisir cet ornement</div></a>
                        <a class="boutonsavecclasse2"  href="../cartes/choix_emplacement_republique_socle2_ornement2.php">
                            <div id="bouton-ornement">Choisir cet ornement</div></a>    
                        <a class="boutonsavecclasse3" href="../cartes/choix_emplacement_republique_socle2_ornement3.php">
                            <div id="bouton-ornement">Choisir cet ornement</div></a>
                        <a class="boutonsavecclasse4"  href="../cartes/choix_emplacement_republique_socle2_ornement4.php">
                            <div id="bouton-ornement">Choisir cet ornement</div></a>    
                        <a class="boutonsavecclasse5"  href="../cartes/choix_emplacement_republique_socle2_ornement5.php">
                            <div id="bouton-ornement">Choisir cet ornement</div></a>    
                                </div>

    ...
    <!--END HEADER-->
        ...
        <div class="contentboxprix"> 
            ...
            <img id="statprix" src="../statues/statue2.png" alt="Victoire ailée (2) (Épée)">
            <img id="socleprix" src="../socles/imgs-socle/socle2.png">
            <img id="ornementprixobe" src="../ornements/img/ornement4.png">
            <img id="listeprixste" src="../prix/img/liste.png">
                </div>
            
            <div class="numeros"><a id="un">1</a><a id="deux">2</a><a id="trois-obe">3</a><a id="quatre-obe">4</a></div>
            
            <div class="recap">
            <ul>
                <li><?php include '../prix/textes/txt-vict-epee.php';?></li>
                <li><?php include '../prix/textes/txt-socle3.php';?></li>
                <li><?php include '../prix/textes/txt-epitaphe.php';?></li>
                <li><?php include '../prix/textes/txt-ornement4.php';?></li>
            </ul>                
            </div>
            ...
            <?php include '../prix/textes/txt-lieu2.php';?>
            </div>
			</div>
            ...
            <div class="tag"><h2>Religieux</h2> <h2>H&eacute;ro&iuml;que</h2></div>
            <div class="separateur3"></div>
            <a href="../gallerie-photo/gallerie-vict-epee2.php">

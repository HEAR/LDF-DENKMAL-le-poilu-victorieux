    ...
    <!--END HEADER-->
        ...
        <div class="contentboxprix"> 
            ...
            <img id="statprix-drapeau" src="../statues/statue13.png"/>
            ...
            <div class="tag"><h2>R&eacute;publicain</h2> <h2>R&eacute;publicain</h2></div>
            <div class="separateur3"></div>
            <a href="../gallerie-photo/gallerie-poilu-fusil.php">

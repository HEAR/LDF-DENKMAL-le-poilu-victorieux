    ...
    <!--END HEADER-->
        ...
        <div class="contentboxprix"> 
            ...
            <img id="ornementprix" src="../ornements/img/ornement5.png">
            <img id="listeprix" src="../prix/img/liste.png">
                </div>
            
            <div class="numeros"><a id="un">1</a><a id="deux">2</a><a id="trois">3</a><a id="quatre">4</a></div>
            ...
            <div class="tag"><h2>H&eacute;ro&iuml;que</h2> <h2>Abstrait</h2></div>

    ...
    <!--END HEADER-->
        ...
        <div class="contentboxprix"> 
            ...
            <img id="ornementprixobe" src="../ornements/img/ornement5.png">
            ...
            <ul>
                ...
                <li><?php include '../prix/textes/txt-ornement5.php';?></li>
            </ul>                
            </div>
            ...
            <?php include '../prix/textes/txt-lieu4.php';?>
            </div>
			</div>
            ...
            <div class="tag"><h2>Patriote</h2> <h2>H&eacute;ro&iuml;que</h2></div>

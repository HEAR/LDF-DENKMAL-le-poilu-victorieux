    ...
    <!--END HEADER-->
       ...
       <div class="eptiaphe">
             <div class="text-entree">
                <form>
<TEXTAREA required onkeyup="reste(this.value);" maxlength="105" class="text-entree" name="champ" rows=5 cols=40>D&icirc;me-sur-for&ecirc;t, &agrave; ses h&eacute;ro&iuml;ques enfants morts pour la France.</TEXTAREA>
           ...
           <a href="../liste/liste-poilu-drapeau-socle1.php">
            ...
            <img id="soclemin" src="../socles/imgs-socle/socle6.png">

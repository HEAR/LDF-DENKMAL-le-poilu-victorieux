    ...
    <!--END HEADER-->
       ...
       <div class="eptiaphe">
             <div class="text-entree">
                <form>
<TEXTAREA required onkeyup="reste(this.value);" maxlength="105" class="text-entree" name="champ" rows=5 cols=40>La commune d'Agny, &agrave; ses enfants morts pour la patrie.</TEXTAREA>
           ...
           <a href="../liste/liste-poilu-drapeau-socle3.php">
            ...
            <img id="soclemin" src="../socles/imgs-socle/socle9.png">
            <img style="display:none;" id="soclemin" src="../socles/imgs-socle/socle10.png">
            <img style="display:none;" id="soclemin" src="../socles/imgs-socle/socle11.png">
                </div>
</div>  
